				...
				<view class="section">
					...
					<list-cell :hover="false" padding="50rpx 30rpx">
						...
						<!-- 	<view class="pay-cell">
							...
							<view class="pay-cell">
								<view>金额总计</view>
								<view class="font-weight-bold">￥{{ order.orderInfo.payAmount }}</view>
							</view>
						</view>
					</list-cell>
				...
				<view class="section">
					...
					<list-cell :hover="false" padding="50rpx 30rpx">
						<view class="w-100 d-flex flex-column">
							<view class="pay-cell">
								<view>下单时间</view>
								<view class="font-weight-bold">{{ order.orderInfo.createTime  }}</view>
							</view>
							<!-- <view class="pay-cell">
								<view>下单门店</view>
							...
							<view class="pay-cell">
								<view>订单号</view>
								<view class="font-weight-bold">{{ order.orderInfo.id }}</view>
							</view>
						</view>
					</list-cell>
					<!-- order info end -->
...
export default {
	...
	onLoad({orderId} ) {
		GetOrderInfoDetail(orderId).then(res =>{
			console.log(res)
			this.order = res
		})
